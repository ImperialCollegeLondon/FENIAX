This is the list of examples that have been tested in the [[https://github.com/ImperialCollegeLondon/FENIAX/blob/master/][FENIAX]] program. The examples and their categories are expected to keep growing.
